<main>
    ...
    <div class="articlewrapper">
        ...
        <div class="adminactions">
            ...
            <div class="admAction"><a href="deleteposts">Удалить пост</a></div>
            <div class="admAction"><a href="editposts">Редактировать пост</a></div>
            <div class="admAction"><a href="../">Вернутся на главную сайта</a></div>
            <div class="admAction"><a href="logout">Выйти из аккаунта</a></div>
        </div>
